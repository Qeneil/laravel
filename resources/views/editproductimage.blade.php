...
<div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pages/</span> Edit Product IMG</h4>
<div class="col-xxl">
                  <div class="card mb-4">
                      ...
                      <form action="{{ route('updateproductimg') }}" method= "POST" enctype="multipart/form-data">
                       ...
                       <input type="hidden" value="{{ $productinfo ->id  }}" name="id">
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary">Update Product img</button>
                          </div>
                        </div>
                      </form>
                    </div>
